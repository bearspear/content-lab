...
export const metadata: FeaturePluginMetadata = {
  id: 'star-map',
  name: 'Star Map',
  description: 'Interactive 3D celestial sphere with real star data and constellations',
  version: '1.0.0',
...
export const plugin: FeaturePlugin = {
  metadata,
  loadComponent: () => import('./star-map.component').then(m => m.StarMapComponent)
};
